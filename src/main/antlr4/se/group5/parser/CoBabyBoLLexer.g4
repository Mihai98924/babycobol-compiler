...
WS
    : ([ ] | CONTINUE_LINE)             -> channel(HIDDEN)
    ;
CONTINUE_LINE
    : LINE_BREAK SOL '-'                -> channel(HIDDEN)
    ;
...
BY_REFERENCE        : BY WS+ R WS* E WS* F WS* E WS* R WS* E WS* N WS* C WS* E;
BY_CONTENT          : BY WS+ C WS* O WS* N WS* T WS* E WS* N WS* T;
BY_VALUE            : BY WS+ V WS* A WS* L WS* U WS* E;
CODE_BY             : BY    -> type(BY);
