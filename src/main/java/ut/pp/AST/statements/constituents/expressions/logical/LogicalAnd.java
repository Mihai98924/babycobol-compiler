...
public class LogicalAnd extends LogicalCompare {

    public LogicalAnd(ParserRuleContext ctx, Expression left, Expression right) throws TypeMismatchError {
