...
public class PotatoLexer extends Lexer {
	...
	private static String[] makeRuleNames() {
		return new String[] {
			...
			"T__17", "T__18", "T__19", "T__20", "T__21", "T__22", "SHARED", "IF", 
			"ELSE", "WHILE", "PRINT", "PRINT_NL", "INPUT", "FORK", "JOIN", "NEW", 
			"LOCK", "SYNC", "LENGTH", "LETTER", "DIGIT", "BIN_DIGIT", "HEX_DIGIT", 
			"CHARACTER", "DEC_INT_LITERAL", "BIN_INT_LITERAL", "HEX_INT_LITERAL", 
	...
	public PotatoLexer(CharStream input) {
		super(input);
