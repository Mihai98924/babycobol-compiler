...
public class SubtractionTest {
    ...
    @Test
    public void programRunTest_SubtractComposites_Giving_Fail() throws IOException {
        // Arrange
        String source = """
                  IDENTIFICATION DIVISION.
                      PROGRAM-ID. ADDTEST.
        ...
        // Assert
        Assert.assertEquals(1.0, (double)program.symbolTable.table.get("CONTAINER.UC.Z.A").getValue(), 0.001);
        Assert.assertEquals(1.0, (double)program.symbolTable.table.get("CONTAINER.UC.Z.B").getValue(), 0.001);
    ...
    @Test
    public void programRunTest_SubtractMultipleComposites_Giving_Fail() throws IOException {
        // Arrange
        String source = """
                  IDENTIFICATION DIVISION.
                      PROGRAM-ID. ADDTEST.
                  ...
                  PROCEDURE DIVISION.
                      ACCEPT A OF X A OF Y B OF UA B OF UB.
                      SUBTRACT X Y X FROM Y GIVING Z.
                      DISPLAY C OF Z.
           """;
        ...
        // Assert
        Assert.assertEquals(-2.0, (double)program.symbolTable.table.get("CONTAINER.UC.Z.A").getValue(), 0.001);
        Assert.assertEquals(-6.0, (double)program.symbolTable.table.get("CONTAINER.UC.Z.B").getValue(), 0.001);
